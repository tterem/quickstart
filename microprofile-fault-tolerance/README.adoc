////
This guide is _ported_ from the main Quarkus repository
https://github.com/quarkusio/quarkus/tree/master/docs/src/main/asciidoc
////
include::../shared-doc/attributes.adoc[]

= microprofile-fault-tolerance: MicroProfile Fault Tolerance
:author: Tomas Hofman, Radoslav Husar
:level: Intermediate
...
// TODO clarify what archetype we can use here
...
and SmallRye Fault Tolerance, which is an implementation of the MicroProfile Fault Tolerance spec that {productName} uses.
